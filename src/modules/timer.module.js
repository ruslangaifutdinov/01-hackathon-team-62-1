...
export class TimerModule extends Module {
    ...
    trigger() {
        if (document.body.querySelector(".timer-wrapper"))
            this.#destructor()
        else
            document.body.append(this.#timerWrapperElement)
    }

    #generateHTML() {
        this.#timerWrapperElement = document.createElement("div")
        this.#timerWrapperElement.className = "timer-wrapper"
        this.#timerWrapperElement.innerHTML =
        ...
        this.#timerWrapperElement.querySelector(".timer-button-start")
            .addEventListener('click', this.#changeTimerStatus.bind(this))
        this.#timerWrapperElement.querySelector(".timer-button-continue")
            .addEventListener('click', this.#changeTimerStatus.bind(this))
        this.#timerWrapperElement.querySelector(".timer-button-stop")
            .addEventListener('click', this.#changeTimerStatus.bind(this))
        this.#timerWrapperElement.querySelector(".timer-button-submit")
    ...
    #initTimer() {
        ...
        const secondsInputElement = this.#timerWrapperElement.querySelector(".timer-seconds-input")

        if (secondsInputElement.value > 9999999999)
            this.#secondsInput = 9999999999
        else if (secondsInputElement.value < 1)
            this.#secondsInput = 1
        else
            this.#secondsInput = Number(secondsInputElement.value)
    ...
    #timeDisplay() {
        ...
        if (this.#minutes < 10)
            this.#minutes = TimerModule.#addZero(this.#minutes)
        if (this.#seconds < 10)
            this.#seconds = TimerModule.#addZero(this.#seconds)
        this.#timerCounterElement.innerHTML =
