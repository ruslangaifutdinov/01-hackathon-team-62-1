...
export class CustomMessageModule extends Module {
    #customMessageWrapperElement; // Main Div block, where message located
    #fetchIDsArray = []; // Array with random IDs to get random quotes
    #fetchedQuotes = []; // Array of quotes received by API
    ...
    ]; // Array of quotes in case fetching process is not possible
    #timeoutID; // SetTimeout special ID for destruction
    ...
    #showQuote() {
        ...
        this.#timeoutID = setTimeout(this.destructor.bind(this), 5000);
    }
}